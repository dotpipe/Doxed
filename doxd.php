...
class Doxed {
    ...
    {
        $this->dox = "Doxed Information for " . substr($file,0,-4) . "\n";
        $docd = 0;
        $total = 0;
        $str = "";
        $aray = [];
    ...
    public function output_methods(string $class, array $aray, int $docd, int $total)
    {
        ...
        {
            $this->classes_undocd++;
            echo "\033[31mError: $class is not doxing ($this->classes_undocd) ($total)\033[39m\n";
            return;
        }
        ...
        file_put_contents("documentation/$class/$class.html", $this->dox);
        $this->dox = "";
    }
}
